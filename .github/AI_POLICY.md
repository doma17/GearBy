...
This policy is inspired by [Ghostty's AI policy][1] and [Fedify's AI policy][2] and [RustPython's AI policy][3].

The GearBy project has the following rules for AI usage:
...
These rules apply only to outside contributions to GearBy.  Maintainers are
...
[3]: https://github.com/RustPython/.github/blob/main/AI_POLICY.md
...
Please remember that GearBy is maintained by humans.
