...
data class CategoryReviewFlagUpdateRequest(
...
data class CorrectionRuleRequest(
    val source: String,
...
data class FeedbackResolutionRequest(
    val resolutionStatus: FeedbackResolutionStatus,
    val resolutionSummary: String,
)

data class ManualCategoryReviewFlagRequest(
    val storeId: UUID?,
    val reason: String,
)

data class StoreRejectionRequest(
